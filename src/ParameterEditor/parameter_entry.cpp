...
ParameterEntry::ParameterEntry()
    : _type(Controller::ParameterType::Int32T)
{}

ParameterEntry::ParameterEntry(const QString& key, const Controller::WrappedParameter& wrapped)
    : m_Key(key)
...
void ParamterEntry::SetKey(QString key)
{
    if (m_Key == key) return;
    m_Key = key;
}
