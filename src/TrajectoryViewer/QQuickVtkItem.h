...
public:
    ...
    void setVTKRenderInstance(vtkSmartPointer<vtkGenericOpenGLRenderWindow> window){

        m_WindowPtr = window;
    }

    auto getVTKRenderInstance() -> vtkSmartPointer<vtkGenericOpenGLRenderWindow> {
...
protected:
    vtkSmartPointer<vtkGenericOpenGLRenderWindow> m_WindowPtr;
};